...
function Login({onSubmit, onChange, username, password, email}) {
    return (
        <div className={styles.register}>
            ...
            <form onSubmit={onSubmit}>
                ...
                <input htmlFor='email' name='email' type='text' value={email} onChange={onChange} placeholder='Your email address'></input><br />
                <buton className={styles.rbutton}>Login</buton>
            </form>
            </div>
        </div>
    )
